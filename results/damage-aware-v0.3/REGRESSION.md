...
Known damage-created/insecure pairs removed: **17/20**.

Strong secure positives retained: **4/6**.
...
| MB-A-002 | retain_secure | KA-RU ~ A-KA-RU | excluded_insecure_base | no |
...
| MB-TI-001 | retain_secure | DA-KU-SE-NE ~ DA-KU-SE-NE-TI | excluded_insecure_base | no |

**Regression status: FAIL (5 cases).**
