# v0.4 regression evaluation

Frozen structural/source negatives excluded: **26/26**.

Frozen secure controls retained: **11/11**.
...
| MB-ME-004 | exclude_structural | SA-RA ~ SA-RA-ME | excluded_structural_variant | editorial_continuation|non_linear_a_script | yes |
...
| MB-TE-003 | retain_secure | KU-NI ~ KU-NI-TE | accepted_secure |  | yes |
